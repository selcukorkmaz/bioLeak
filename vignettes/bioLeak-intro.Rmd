...
if (requireNamespace("rsample", quietly = TRUE) &&
  ...
  set.seed(13)
  rs <- rsample::group_vfold_cv(df, group = subject, v = 5)
  ...
  rs_export <- as_rsample(safe_splits, data = df)
} else {
  cat("rsample/recipes/yardstick/parsnip not installed; skipping tidymodels example.\n")
}
```
...
if (requireNamespace("tune", quietly = TRUE) &&
  ...
  cat("tune/dials/recipes/parsnip/glmnet/yardstick/rsample/workflows not installed; skipping tuning example.\n")
}
```
